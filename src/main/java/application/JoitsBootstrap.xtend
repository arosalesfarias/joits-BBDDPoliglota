...
//	AbstractRepository<Funcion> repoFunciones = ApplicationContext.instance.getSingleton(typeof(RepoFunciones))
	override run() {
		...
		// Funciones (27)
		val funcionBatmanFinde = new Funcion(1, LocalDateTime.of(2019, 03, 03, 13, 30), "5")
		val funcionSupermanFinde = new Funcion(2, LocalDateTime.of(2019, 03, 03, 13, 30), "8")
		val funcionSagaFinde = new Funcion(3, LocalDateTime.of(2019, 03, 03, 13, 30), "2")
		val funcionVolver1Finde = new Funcion(4, LocalDateTime.of(2019, 03, 03, 13, 30), "1")
		val funcionVolver2Finde = new Funcion(5, LocalDateTime.of(2019, 03, 03, 13, 30), "9")
		val funcionVolver3Finde = new Funcion(6, LocalDateTime.of(2019, 03, 03, 13, 30), "7")
		val funcionAvengers1Finde = new Funcion(7, LocalDateTime.of(2019, 03, 03, 13, 30), "11")
		val funcionAvengers2Finde = new Funcion(8, LocalDateTime.of(2019, 03, 03, 13, 30), "14")
		val funcionAvengers3Finde = new Funcion(9, LocalDateTime.of(2019, 03, 03, 13, 30), "18")
		val funcionBatmanLunes = new Funcion(10, LocalDateTime.of(2019, 03, 04, 13, 30), "8")
		val funcionSupermanLunes = new Funcion(11, LocalDateTime.of(2019, 03, 04, 13, 30), "5")
		val funcionSagaLunes = new Funcion(12, LocalDateTime.of(2019, 03, 04, 13, 30), "10")
		val funcionVolver1Lunes = new Funcion(13, LocalDateTime.of(2019, 03, 04, 13, 30), "4")
		val funcionVolver2Lunes = new Funcion(14, LocalDateTime.of(2019, 03, 04, 13, 30), "2")
		val funcionVolver3Lunes = new Funcion(15, LocalDateTime.of(2019, 03, 04, 13, 30), "7")
		val funcionAvengers1Lunes = new Funcion(16, LocalDateTime.of(2019, 03, 04, 13, 30), "12")
		val funcionAvengers2Lunes = new Funcion(17, LocalDateTime.of(2019, 03, 04, 13, 30), "15")
		val funcionAvengers3Lunes = new Funcion(18, LocalDateTime.of(2019, 03, 04, 13, 30), "1")
		val funcionBatmanMiercoles = new Funcion(19, LocalDateTime.of(2019, 03, 06, 13, 30), "1")
		val funcionSupermanMiercoles = new Funcion(20, LocalDateTime.of(2019, 03, 06, 13, 30), "7")
		val funcionSagaMiercoles = new Funcion(21, LocalDateTime.of(2019, 03, 06, 13, 30), "4")
		val funcionVolver1Miercoles = new Funcion(22, LocalDateTime.of(2019, 03, 06, 13, 30), "10")
		val funcionVolver2Miercoles = new Funcion(23, LocalDateTime.of(2019, 03, 06, 13, 30), "8")
		val funcionVolver3Miercoles = new Funcion(24, LocalDateTime.of(2019, 03, 06, 13, 30), "2")
		val funcionAvengers1Miercoles = new Funcion(25, LocalDateTime.of(2019, 03, 06, 13, 30), "6")
		val funcionAvengers2Miercoles = new Funcion(26, LocalDateTime.of(2019, 03, 06, 13, 30), "17")
		val funcionAvengers3Miercoles = new Funcion(27, LocalDateTime.of(2019, 03, 06, 13, 30), "12")
